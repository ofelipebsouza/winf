      ...
      <footer className="relative w-full py-28 px-6 sm:px-12 md:px-16 bg-black border-t border-white/10 text-xs font-mono">
        <div className="max-w-7xl mx-auto space-y-20">
          ...
          <div className="flex items-center gap-6 text-zinc-400 border-t border-white/10 pt-8">
            ...
            <a href="https://twitter.com/koenigsegg" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Twitter">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 text-[10px] text-zinc-600 tracking-wider uppercase border-t border-white/5 pt-6">
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="#" className="hover:text-zinc-400 transition-colors">Legal Links</a>
              <a href="#" className="hover:text-zinc-400 transition-colors">Investor relations</a>
            </div>
          </div>
